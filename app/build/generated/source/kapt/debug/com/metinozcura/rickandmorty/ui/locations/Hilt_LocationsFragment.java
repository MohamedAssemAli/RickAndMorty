...
public abstract class Hilt_LocationsFragment<DB extends ViewDataBinding, VM extends BaseViewModel> extends BaseFragment<DB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LocationsFragment_GeneratedInjector) this.generatedComponent()).injectLocationsFragment(UnsafeCasts.<LocationsFragment>unsafeCast(this));
    }
  }
