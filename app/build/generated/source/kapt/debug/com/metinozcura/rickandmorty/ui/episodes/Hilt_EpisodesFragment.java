...
public abstract class Hilt_EpisodesFragment<DB extends ViewDataBinding, VM extends BaseViewModel> extends BaseFragment<DB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EpisodesFragment_GeneratedInjector) this.generatedComponent()).injectEpisodesFragment(UnsafeCasts.<EpisodesFragment>unsafeCast(this));
    }
  }
